...
process.GlobalTag.toGet = cms.VPSet(
        ...
        cms.PSet(record = cms.string("EcalTPGPhysicsConstRcd"),
                 tag = cms.string("EcalTPGPhysicsConst_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGFineGrainEBGroupRcd"),
                 tag = cms.string("EcalTPGFineGrainEBGroup_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGFineGrainEBIdMapRcd"),
                 tag = cms.string("EcalTPGFineGrainEBIdMap_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGFineGrainStripEERcd"),
                 tag = cms.string("EcalTPGFineGrainStripEE_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGFineGrainTowerEERcd"),
                 tag = cms.string("EcalTPGFineGrainTowerEE_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGLinearizationConstRcd"),
                 tag = cms.string("EcalTPGLinearizationConst_2017_07_20_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGLutGroupRcd"),
                 tag = cms.string("EcalTPGLutGroup_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGLutIdMapRcd"),
                 tag = cms.string("EcalTPGLutIdMap_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGPedestalsRcd"),
                 tag = cms.string("EcalTPGPedestals_2017_07_20_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGSlidingWindowRcd"),
                 tag = cms.string("EcalTPGSlidingWindow_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGSpikeRcd"),
                 tag = cms.string("EcalTPGSpike_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGWeightGroupRcd"),
                 tag = cms.string("EcalTPGWeightGroup_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalTPGWeightIdMapRcd"),
                 tag = cms.string("EcalTPGWeightIdMap_2017_mc"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
        cms.PSet(record = cms.string("EcalLaserAPDPNRatiosRcd"),
                 tag = cms.string("EcalLaser_APDPNRatio_2017_07_20_6444809065729097728"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 )
