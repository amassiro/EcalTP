...
process.GlobalTag.toGet = cms.VPSet(
     ...
     cms.PSet(record = cms.string("EcalLaserAPDPNRatiosRcd"),
                   tag = cms.string("EcalLaserAPDPNRatios_mc_2018_15fb_317090"),                    
                   connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                  ),

   cms.PSet(record = cms.string("EcalPedestalsRcd"),
                   tag = cms.string("EcalPedestals_mc_2018_15fb_316995"),
                   connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                  ),


   cms.PSet(record = cms.string("EcalTPGLinearizationConstRcd"),
                   tag = cms.string("EcalTPGLinearizationConst_mc_2018_15fb"),
                   connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                  ),

 
   cms.PSet(record = cms.string("EcalTPGPedestalsRcd"),
                   tag = cms.string("EcalTPGPedestals_mc_2018_15fb"),
