...
process.TreeProducer = cms.EDAnalyzer('TreeProducerComparison',
                           ...
                           EcalUncalibRecHitsWeightsEBCollection = cms.InputTag("ecalUncalibRecHit","EcalUncalibRecHitsEB"),
                           EcalUncalibRecHitsWeightsEECollection = cms.InputTag("ecalUncalibRecHit","EcalUncalibRecHitsEE"),
